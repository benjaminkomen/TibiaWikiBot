...
public enum BookType implements Description {
    ...
    DOCUMENT_REWRITEABLE("Document (Rewriteable)"),
    ...
    ORNATE_TOME_OBJECT("Ornate Tome (Object)"),
    PAGE_FROM_A_MYSTIC_BOOK("Page from a Mystic Book"),
    PAPER("Paper"),
    PIECE_OF_PAPER("Piece of Paper"),
    PIECE_OF_PAPER_BLANK("Piece of Paper (Blank)"),
    PIECE_OF_PAPER_OBJECT("Piece of Paper (Object)"),
    PARCHMENT("Parchment"),
